...
public class AddressBook2 implements ActionListener{
	...
	//////////////////////////////////[[ 조회결과를 처리  ]]////////////////////////////////////
		...
		dVO = null;
		final Vector<DeptVO> al = new Vector<DeptVO>();
		while(rs.next()) {
			dVO = new DeptVO();
			...
			for(int i=0;i<dVOS.length;i++) {
				final Vector oneRow = new Vector();
...
//////////////////////////////////[[ 조회결과를 처리  ]]////////////////////////////////////
			...
			final DBConnectionMgr dbMgr = DBConnectionMgr.getInstance();
			final Connection con = dbMgr.getConnection();
			if(con !=null) {
