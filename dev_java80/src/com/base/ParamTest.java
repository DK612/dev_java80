...
public class ParamTest {
	...
	public static void main(String[] args) {
		...
		//p의 주소를 전달하였으나 p에 무언가 새로 할당된것이 아니므로 p는 기존의 #1 Param클래스의 주소를 그대로 가지고 있다.
		//그러므로 main의 p.ival은 #1 Param의 속성이다
	}
	void effectParam(Param p) {
		p = new Param();//#2  //Param형 매개변수 p에 새로운 #2 Param클래스의 주소가 할당됨
		p.ival = 500;	// 새로 할당되었으므로 main에서 사용된 #1 Param클래스와는 다른객체다.
